...
source_path='E:\submit_08-Sep-2016\';

convert_path=[source_path,'convert/'];
...
multi_file=sdir([source_path,'*.nc']);

for ifile=1:length(multi_file)
    
file_name=multi_file(ifile).name;
working_file=[convert_path,'junk.nc'];
convert_file=[convert_path,file_name];
...
'2.2'
        ...
        %    formate file
        temp_file=[convert_path,'temp.nc'];
